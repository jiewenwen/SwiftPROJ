...
extension City {
    static var top20USCities: [City] = [
        ...
        City(name: "San Antonio", state: "Texas", population: 1451853, area: Measurement(value: 1291.9, unit: UnitArea.squareKilometers)),        City(name: "San Diego", state: "California", population: 1381611, area: Measurement(value: 844.1, unit: UnitArea.squareKilometers)),
